export const projects = [
  ...
  },
  {
    ...
    description: "SEOCHU is an NLP powered web service which helps your website improve its SEO ranking drastically. It crawls through your website pages individually and suggests the names and places of keywords which on adding can improve your website’s SEO. It even suggests backlinks by mining through the area of interest of your website. ",
      ...
      tags: ['Bootstrap', 'Javascript', 'Python', 'Flask'],
  ...
  {
    title: 'Bibler',
    description: "Bibler is a cross-Platform mobile application based on the React Native platform which renders users navigate the entire library by a click of a button and seek their desired book. Bibler tells it’s users whether the book is available in the library or not. It even tells where to find it making it extremely simple and incredibly easy for the users. In case, if the book is not available in the library at that time, then it even tells when it is going to come.",
      image: '/images/Bibler.png',
      tags: ['React Native', 'Php'],
    source: 'https://github.com/dharan1999/Bibler',
    visit: 'https://github.com/dharan1999/Bibler',
    id: 2,
  },
  {
    title: 'Inception',
...
export const TimeLineData = [
  { year: 2017, text: 'Started my Undergrad Degree in Computer Engineering ', },
  { year: 2018, text: 'Worked as a part time Web developer and Digital Marketer', },
  { year: 2019, text: 'Created many projects in React, Php and Machine Learning while studying', },
  { year: 2021, text: 'Completed my Undergrad and started my graduate program at Concordia University', },
